...
# this, you’re going to have to remember a bit about string parsing in Python 3.
# I talked a little bit about it in this post.

original_file = [line.strip() for line in open('22.txt', 'r')]
dupes = {i:original_file.count(i) for i in original_file}
print(dupes)